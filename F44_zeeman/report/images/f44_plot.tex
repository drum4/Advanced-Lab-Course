...
\includepdf[pages=-, landscape=false]{sigma_lines.pdf}
...
\includepdf[pages=-, landscape=true]{f44_abb_7.pdf}
\newpage 
\thispagestyle{empty}
\quad 
\newpage
\includepdf[pages=-, landscape=true]{f44_abb_8.pdf}
\includepdf[pages=-, landscape=true]{f44_abb_9.pdf}
\includepdf[pages=-, landscape=true]{f44_abb_10.pdf}
\includepdf[pages=-, landscape=true]{f44_abb_11.pdf}
\includepdf[pages=-, landscape=true]{f44_abb_12.pdf}
\end{document}