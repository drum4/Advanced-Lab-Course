...
plt.plot(x[129:162], Gauss(x[129:162],*popt49), color='blue', label='Linearer Fit')
plt.plot(x[180:207], Gauss(x[180:207],*popt50), color='blue', label='Linearer Fit')
plt.plot(x[222:255], Gauss(x[222:255],*popt51), color='blue', label='Linearer Fit')
plt.plot(x[271:297], Gauss(x[271:297],*popt52), color='blue', label='Linearer Fit')
plt.plot(x[318:346], Gauss(x[318:346],*popt53), color='blue', label='Linearer Fit')
plt.plot(x[370:392], Gauss(x[370:392],*popt54), color='blue', label='Linearer Fit')
plt.plot(x[420:445], Gauss(x[420:445],*popt55), color='blue', label='Linearer Fit')
plt.plot(x[475:495], Gauss(x[475:495],*popt56), color='blue', label='Linearer Fit')
plt.plot(x[524:545], Gauss(x[524:545],*popt57), color='blue', label='Linearer Fit')
plt.plot(x[580:600], Gauss(x[580:600],*popt58), color='blue', label='Linearer Fit')
plt.plot(x[630:650], Gauss(x[630:650],*popt59), color='blue', label='Linearer Fit')
