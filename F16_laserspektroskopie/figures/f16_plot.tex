...
\pagestyle{empty}
\centering
\includepdf[pages=-, landscape=true]{f16_abb_1.pdf}
\includepdf[pages=-, landscape=true]{f16_abb_2.pdf}
\includepdf[pages=-, landscape=true]{f16_abb_3.pdf}
\includepdf[pages=-, landscape=true]{f16_abb_4.pdf}
\includepdf[pages=-, landscape=true]{f16_abb_5.pdf}
\end{document}