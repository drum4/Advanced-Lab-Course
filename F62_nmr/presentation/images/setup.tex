...
\draw[arrows=-{Stealth[scale=1]},ultra thick, color=myred, dashed](6.25,.75)--(7.35,.75);
\draw[arrows=-{Stealth[scale=1]},ultra thick, color=myred](6.25,.75)--(5.75,-.25) node[right]{$M$};
\end{tikzpicture}